...
/**
 * SlidingNumber displays a number with animated sliding digits.
 *
 * @example
 * <SlidingNumber value={42} />
 * // Renders: 42 with sliding animation
 *
 * @example
 * <SlidingNumber value={-7.5} padStart decimalSeparator="," />
 * // Renders: -07,5 with sliding animation
 */
const SlidingNumber = React.memo(
  ({ value, padStart = false, decimalSeparator = "." }: SlidingNumberProps) => {
